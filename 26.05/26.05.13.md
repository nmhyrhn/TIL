...
`chap15-enum`, `chap16-lambda`, `chap17-stream` 예제를 통해 자바에서 자주 쓰이지만 처음엔 추상적으로 느껴지는 세 가지를 정리했다.  
이번에는 문법 자체보다 “왜 쓰는지”, “실무에서 어떤 코드가 많이 나오는지”, “어떻게 읽으면 되는지” 중심으로 이해하는 게 더 중요했다.
